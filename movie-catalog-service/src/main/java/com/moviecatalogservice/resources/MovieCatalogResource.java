...
import com.moviecatalogservice.services.TrendingMoviesGrpcClient;
...
public class MovieCatalogResource {
    ...
    private final TrendingMoviesGrpcClient trendingMoviesGrpcClient;

    public MovieCatalogResource(MovieInfoService movieInfoService,
                                UserRatingService userRatingService,
                                TrendingMoviesGrpcClient trendingMoviesGrpcClient) {
        this.movieInfoService = movieInfoService;
        this.userRatingService = userRatingService;
        this.trendingMoviesGrpcClient = trendingMoviesGrpcClient;
    }
    ...
    public List<String> getTrendingMovies() {
        return trendingMoviesGrpcClient.getTopMovieIds();
    }
}
